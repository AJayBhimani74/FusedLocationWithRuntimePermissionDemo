...
public class MainActivity extends PermissionMasterActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private boolean isResolutionShowing;
    ...
    protected void onResume() {
        super.onResume();
        if (hasPermissions(new String[]{Manifest.permission.ACCESS_FINE_LOCATION}) && !isResolutionShowing) {
            getFusedLocation();
        } else if (isSettingRequested()) {

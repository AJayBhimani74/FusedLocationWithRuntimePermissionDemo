...
public abstract class PermissionMasterActivity extends AppCompatActivity {
    ...
    private void showRequestPermissionDialog() {
        ...
        alertDialogBuilder.setPositiveButton(positiveButton, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                ActivityCompat.requestPermissions(PermissionMasterActivity.this, mPermission.getRequestedPermissions(), mPermission.getRequestCode());
            }
        });
    ...
    public void startSettingActivity() {
        ...
        isSettingRequested = true;
        this.startActivity(intent);
    }

    public boolean isSettingRequested() {
        return isSettingRequested;
    }

    public void setSettingRequested(boolean settingRequested) {
        isSettingRequested = settingRequested;
    }
}
